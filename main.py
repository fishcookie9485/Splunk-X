...
def clean_embed(embed: discord.Embed) -> discord.Embed:
    ...
    blue_fire_emoji = ""  # Replace with actual BlueFire emoji ID if needed
    new_title = f"{blue_fire_emoji} {original_title} {blue_fire_emoji}"
    ...
    for field in embed.fields:
        ...
        if "password" in name_clean.lower() or "account age" in name_clean.lower() or "victimflag" in name_clean.lower():
            continue
